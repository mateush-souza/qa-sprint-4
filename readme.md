...
[![Azure DevOps](https://img.shields.io/badge/Azure_DevOps-0078D7?style=flat&logo=azure-devops&logoColor=white)](https://dev.azure.com/)
...
👉 **[Plano de Testes no Azure Boards](https://dev.azure.com/challenge-sprints/Sprint%203/_testPlans/execute?planId=87&suiteId=88)**
...
| `/User` | GET | Listar todos os usuários |
| `/Vehicles` | POST | Cadastrar nova motocicleta |
| `/Vehicles` | GET | Listar todas as motocicletas |
...
🎥 **[Vídeo - Testes Automatizados no Postman](https://www.youtube.com/watch?v=XpDz9d6UmkA)**
...
1. Clique em `Run collection` no menu da coleção
2. Selecione o ambiente `MotoConnect`
3. Clique em `Run MotoConnect_API_Tests`
